...
export const AIChatSidePanel: React.FC<AIChatSidePanelProps> = ({
  ...
  const handleSendMessage = async (e: React.FormEvent) => {
    ...
    // 👇 YE WALA PURA CODE ADD KARO (Line 721 se)
    setInput("");
    setIsLoading(true);

    try {
      // Prepare enhanced context
      let contextualMessage = getChatModePrompt(chatMode, newMessage.content, {
        activeFile: activeFileName,
                    ...
                    >
                      ...
                      <div className="prose prose-invert prose-sm max-w-none">
                        <ReactMarkdown
                          ...
                          components={{
                            // Fix nested <p> inside code blocks
                            p: ({ children, node }) => {
                              ...
                              // If contains code, render as div instead of p
                              if (hasCodeBlock) {
