...
import { createPlayground } from "@/modules/playground/actions/index";
    ...
    <>
      ...
      >
        <div className="flex flex-row justify-center items-start gap-4">
         <button
             className="flex justify-center items-center w-12 h-12 rounded-md border border-border bg-card 
            group-hover:bg-accent group-hover:border-[#E93F3F] group-hover:text-[#E93F3F] 
