...
import { getAllPlaygroundForUser , deleteProjectById ,editProjectById , duplicateProjectById} from "@/modules/playground/actions/index";
...
const DashboardMainPage = async () => {
  ...
  return (
    <div suppressHydrationWarning className="flex flex-col justify-start items-center min-h-screen mx-auto max-w-7xl px-4 py-10">
