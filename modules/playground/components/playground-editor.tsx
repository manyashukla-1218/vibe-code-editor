...
import { configureMonaco, defaultEditorOptions, getEditorLanguage } from "@/modules/playground/libs/editor-config"
...
export const PlaygroundEditor = ({
  ...
  const handleEditorDidMount = (editor: any, monaco: Monaco) => {
    ...
    // FIX: Safely dispose previous tab command if it exists and has dispose method
  ...
  useEffect(() => {
    return () => {
      ...
      // FIX: Safely dispose tab command with proper null check and dispose method check
      if (tabCommandRef.current && typeof tabCommandRef.current.dispose === 'function') {
        try {
          tabCommandRef.current.dispose()
        } catch (error) {
